...
var H5ComponentRing =function ( name, cfg ) {
  ...
  //  任务二：(2) 重设配置中的 type 参数，不仅利用 H5ComponentPia 
  //  构建 DOM 结构和 JS 逻辑，也使用其 CSS 样式定义（思考下为什么能达到这个效果）
  cfg.type = 'pia';
  var component =  new H5ComponentPia( name ,cfg );

  //  任务二：(3) 修正组件的样式，以支持在样式文件中组件的样式定义
  //   .h5_component_ring 相关样式能生效
